<template>
  <el-card class="square-container">
    <el-form inline>
      ...
      <el-form-item>
        <el-input-number
          v-model="topPrice"
          style="width: 100px"
          :min="lowPrice === undefined ? 0 : lowPrice"
          :max="999999999999"
          :step="100"
          placeholder="最高"
          controls-position="right"
      ...
      <el-button type="info" @click="searchList">
        ...
        搜索</el-button
      >
      <el-button type="danger" v-if="isAuth(['ROOT', 'SECONDHAND:DELETE'])" @click="onRemoveClick()"
        >批量删除</el-button
      >
      <el-button type="success" v-if="isAuth(['ROOT', 'SECONDHAND:UPDATE'])" @click="changeStatus(1)"
        >批量上架</el-button
      >
      <el-button type="warning" v-if="isAuth(['ROOT', 'SECONDHAND:UPDATE'])" @click="changeStatus(0)"
        >批量下架</el-button
      >
    </el-form>
    <el-table
    ...
    >
      ...
      <el-table-column prop="oriPrice" label="原价" align="center" width="100"></el-table-column>
      <el-table-column prop="nowPrice" label="现价" align="center" width="100"></el-table-column>
      <el-table-column prop="createTime" label="上架时间" align="center" width="170">
      ...
      <el-table-column label="操作" fixed="right" align="center" width="300">
        <template #default="{ row }">
          ...
          <el-button
            ...
            size="small"
            v-if="isAuth(['ROOT', 'SECONDHAND:UPDATE']) && multipleSelection.length == 0"
...
import { getSechandList, deleteSechands, updateStatus } from '@/api/sechand'
...
const getListData = async () => {
  if (topPrice.value < lowPrice.value) {
    topPrice.value = lowPrice.value
  }
  const param = {
    ...
    topPrice: topPrice.value,
    keywords: search.value
  }
  const result = await getSechandList(param)
